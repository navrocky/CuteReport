...
#ifndef DETAILFOOTER_P_H
#define DETAILFOOTER_P_H

#include "bandinterface.h"
#include "bandinterface_p.h"


class DetailFooterPrivate : public CuteReport::BandInterfacePrivate
{
public:
    explicit DetailFooterPrivate():
        BandInterfacePrivate()
    {}


    virtual ~DetailFooterPrivate(){}
