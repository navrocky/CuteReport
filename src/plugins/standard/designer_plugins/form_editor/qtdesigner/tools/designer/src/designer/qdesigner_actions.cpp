...
//bool QDesignerActions::showNewFormDialog(const QString &fileName)
//{
//    closePreview();
...
{
//    if (workbench()->mode() == DockedMode) {
//        QStatusBar *bar = workbench()->designer()->mainWindow()->statusBar();
//        if (bar && !bar->isHidden())
//            bar->showMessage(message, 3000);
//    }

    workbench()->emitMessage(this, message, 3000);
}
